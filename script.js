...
// * crear una funcion que remueva todos los espacios vacios de un string
...
function noSpaces(string) {
  ...
  for (let char of string) {
    ...
    // if
    if (char !== " ") {
      noSpacesStr = noSpacesStr + char;
    }
  }
  return noSpacesStr;
}

console.log(noSpaces("esto es un string de prueba"));
console.log(noSpaces("  esto es   un string   extraño   "));

// otro ejemplo

let veggieBasket1 = ["patata", "zanahoria", "lechuga", "cebolla"];
let veggieBasket2 = ["patata", "celery", "lechuga", "tomate"];

// crear una funcion que reciba:
// 1. una cesta de vegetales
// 2. un vegetal
// me tiene que decir si consigue el vegetal: "He encontrado el vegetal: XXXXX"
// si no lo consigue, me dirá: "No podemos hacer ensalada"
// BONUS si la cesta esta vacia dirá: "No tienes vegetales :("

function findVeggie(veggieArr, veggie) {
  // clausulas de guardia (guard clauses)
  if (veggieArr.length === 0) {
    return "No tienes vegetales :(";
  }

  // if
  if (veggieArr.includes(veggie)) {
    return `He encontrado el vegetal: ${veggie}`;
  } else {
    return "No podemos hacer ensalada";
  }
}

console.log(findVeggie(veggieBasket1, "cebolla")); // "He encontrado el vegetal: Cebolla"
console.log(findVeggie(veggieBasket2, "zanahoria")); // "No podemos hacer ensalada"
console.log(findVeggie([], "cebolla"));
